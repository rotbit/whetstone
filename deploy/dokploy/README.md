...
WHETSTONE_OSS_REGION=cn-hangzhou
WHETSTONE_OSS_ENDPOINT=https://oss-cn-hangzhou.aliyuncs.com
WHETSTONE_OSS_BUCKET=请替换为私有Bucket名称
WHETSTONE_OSS_ACCESS_KEY_ID=请替换为RAM用户AccessKey ID
WHETSTONE_OSS_ACCESS_KEY_SECRET=请替换为RAM用户AccessKey Secret
WHETSTONE_OSS_OBJECT_URL_PREFIX=https://请替换为Bucket域名或自定义域名
...
OSS_REGION=${{environment.WHETSTONE_OSS_REGION}}
OSS_ENDPOINT=${{environment.WHETSTONE_OSS_ENDPOINT}}
OSS_BUCKET=${{environment.WHETSTONE_OSS_BUCKET}}
OSS_ACCESS_KEY_ID=${{environment.WHETSTONE_OSS_ACCESS_KEY_ID}}
OSS_ACCESS_KEY_SECRET=${{environment.WHETSTONE_OSS_ACCESS_KEY_SECRET}}
OSS_OBJECT_URL_PREFIX=${{environment.WHETSTONE_OSS_OBJECT_URL_PREFIX}}
